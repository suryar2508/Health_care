...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"><span class="cstat-no" title="statement not covered" >import { Router } from 'express';</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >router.get('/health', <span class="fstat-no" title="function not covered" >async </span>(_req, res) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
    const dbStatus = <span class="cstat-no" title="statement not covered" >mongoose.connection.readyState === 1 ? 'connected' : 'disconnected';</span>
    const memoryUsage = <span class="cstat-no" title="statement not covered" >process.memoryUsage();</span>
